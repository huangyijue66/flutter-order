...
class DishListState extends State<DishList> {
  ...
  @override
  Widget build(BuildContext context) {
    dish = Provider.of<DishModel2>(context);
              ...
              Expanded(
                child: InkWell(
                  ...
                  onTap: (){
                    ...
                    Navigator.of(context).pushNamed('/dishDetail2');
                  },
                ),
              ),
...
class ToTalPrice2 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    // TODO: implement build
    return Consumer<CartModel2>(builder: (context, cart, widght){
      return Text('热菜总额:${cart.getTotalPrice()}',style: TextStyle(color: Colors.red, fontSize: 40),);
    });
  }
